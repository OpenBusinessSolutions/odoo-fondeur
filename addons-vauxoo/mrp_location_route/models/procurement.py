...
class ProcurementRule(models.Model):
    ...
    destination_bom_id = fields.Many2one(
        'stock.location',
        string='Location of Finished Material',
        domain="[('usage', '=', 'internal'), ('id', '!=', location_id)]",
        help='MO created from procurement will put finished material to here'
    )
...
class ProcurementOrder(models.Model):
    ...
    def _prepare_mo_vals(self, procurement):
        ...
        if procurement.rule_id.location_bom_id:
            ...
            'location_dest_id': procurement.rule_id.destination_bom_id.id} )
        return res
