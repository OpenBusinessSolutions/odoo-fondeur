...
class MrpProductPosition(models.Model):
    _name = 'mrp.product.position'
...
class MrpBomLine(models.Model):
    ...
    product_position_ids = fields.Many2many('mrp.product.position', 'mrp_bom_line_product_position', 'product_id', 'mrp_bom_line_id', string='Posicion', help='Seleccione una o varias posiciones para este producto')
